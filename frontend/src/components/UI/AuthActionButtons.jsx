...
const auth = [
  {
    ...
    className:
      "bg-white text-purple-500 border-2 border-purple-500 hover:bg-gray-100",
  },
  {
    id: "4",
    name: "Register",
    ...
    className:
      "bg-gray-800 text-white border-2 border-black hover:bg-purple-500 hover:border-purple-500",
  },
];
      ...
      {userInfo ? (
        <>
          <Button
            ...
            className="gap-2 bg-red-500 text-white border-2 border-red-500 hover:bg-red-600"
          >
